...
As expected, the accuracy of this model (`r round(accuracy * 100, 3)`%) is very poor. It is a simple model based on dividing features to isolate answers.
...
The accuracy of the random forest model (`r round(accuracy * 100, 3)`%) is
